...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _defaultPointColor = [UIColor colorWithHexValue:@"fb9b46" alpha:1.0];
...
-(void) initializePoints
{
    ...
    for (int i = 0; i < 5; i++) {
        ...
        if (i == 0){
            point.backgroundColor = [UIColor colorWithHexValue:@"ffffff" alpha:1.0].CGColor;
        }
...
-(void)setSelectionAtIndex:(NSInteger)index
{
    if (index >= 0 && index < _points.count)
    {
        ...
        selectedPoint.backgroundColor = [UIColor whiteColor].CGColor;
    }
}
